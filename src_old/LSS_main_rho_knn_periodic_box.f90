...
subroutine ps_within_margin(ps1, n1, ps2, n2, boxsize, margin)
        ...
        do i = 1, n1
                ...
                if(-margin<x .and. x<boxsize+margin .and. -margin<y .and. y<boxsize+margin .and. -margin<z .and. z<boxsize+margin) then
...
!        write(*,'(A,i10,A,i10,A)') ' (rho_knn_periodic_box) ', npar2, ' particles stored in par2s.'
        ...
        enddo
        print *
        write(*,'(A,i10,A,i10,A,f5.2,A,i10,A,f5.2,A)') ' (rho_knn_periodic_box) Finishing rho-estimate for ', npar1, '  particles. ', n1, '(',&
