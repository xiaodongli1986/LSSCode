...
implicit none
	...
	printstr = "Adding a number 1 to your every line of file, "//&
		"Usage: LSS_main_mpi_add1 -inputfile inputfilename -suffixstr your_suffix  -use_filelist true "
...
101             close(10000)
                write(*,'(A,i4,i4,";",i12,A,A,";",i12,A,A)')'myid, nproc = ', &
			myid, nproc, iline, 'lines read from ', trim(adjustl(file1)), iwriteline, 'lines write to ', trim(adjustl(file2)) 
        enddo    
