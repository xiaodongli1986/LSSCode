...
!} SavedHaloType;
        ...
        print *, 'This programme is created but later found no longer usable!...'
        stop
        ...
        outputfilename = &
                '/home/xiaodongli/SparseFilaments/data/input/HR4/LC_check_2pcf_of_diff_mass_cut/' &
        ...
        do i = 1, 16
                ...
                !open(unit=100,file=inputfilename,form='binary',action='read') ! gfortran fmt
