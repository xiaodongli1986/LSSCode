...
implicit none
	...
	character(len=char_len) :: tmpstr1, tmpstr2, tmpstr3, tmpstr4, tmpstr5, inputfilelist, outputfile, printstr, suffix, infofile, outputname
	...
	printstr = '### Cut a sample into small samples with overlapping. Usage: mpirun -np ??? EXE -inputfilelist ? -outputname ?  -nbox ? -overlap_distance ? -xyzmin ? -xyzmax ? -add1 T/F'
